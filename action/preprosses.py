...
#feed it a sentry of the tacker.json and gives back a dict that contains a form
...
for jentry in tracker:
    ...
    if len(pentry['forms']):    #if it has at least at least one form, download a thumb
        downloadThumb(pentry['id'])
